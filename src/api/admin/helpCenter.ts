...
export const fetchHelpMainTopics = async (): Promise<HelpMainTopic[]> => {
  const response = await axiosInstance.get("/systems/admin/help_main");
...
export const createHelpMainTopic = async (
  ...
  const response = await axiosInstance.post("/systems/admin/help_main", data);
  return response.data;
};
...
export const deleteHelpMainTopic = async (id: string): Promise<void> => {
  await axiosInstance.delete(`/systems/admin/help_main/${id}`);
};
...
export const fetchHelpTopicsByMainId = async (
  ...
  const response = await axiosInstance.get(
    `/systems/admin/help_topics/main/${mainId}`
  );
  return response.data;
};

export const fetchHelpTopic = async (id: string): Promise<HelpTopic> => {
  const response = await axiosInstance.get(`/systems/admin/help_topics/${id}`);
  return response.data;
};
...
export const createHelpTopic = async (
  ...
  const response = await axiosInstance.post("/systems/admin/help_topics", data);
  return response.data;
};
...
export const deleteHelpTopic = async (id: string): Promise<void> => {
  await axiosInstance.delete(`/systems/admin/help_topics/${id}`);
};
...
export const reorderHelpMainTopic = async (
  ...
  await axiosInstance.put("/systems/admin/help_main/reorder", {
    main_id: mainId,
    new_order: newOrder,
  });
};
...
export const reorderHelpTopic = async (
  ...
  await axiosInstance.put("/systems/admin/help_topics/reorder", {
    topic_id: topicId,
    new_order: newOrder,
  });
};
