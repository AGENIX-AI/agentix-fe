const viTranslation = {
  ...
  "home_subtitle": "Tham gia cùng hàng nghìn người học trên khắp thế giới trên nền tảng hiện đại của chúng tôi.",
  ...
  "auth": {
    "login": {
      ...
      "hints": {
        "linkSent": {
          ...
          "message": "Chúng tôi đã gửi một liên kết ma thuật đến địa chỉ email của bạn. Vui lòng nhấp vào liên kết để đăng nhập."
        }
      }
    },
    "magicLink": {
    ...
    "errors": {
      ...
      "invalidCredentials": "Thông tin đăng nhập không hợp lệ. Vui lòng kiểm tra email và mật khẩu của bạn.",
  ...
  "organizations": {
    "invitation": {
      ...
      "message": "Bạn đã được mời tham gia một tổ chức. Hoàn tất đăng nhập để chấp nhận."
    }
  },
  
  // Dashboard
  "dashboard_welcome": "Chào mừng đến với bảng điều khiển Edvara của bạn. Trang này được bảo vệ và chỉ có thể truy cập sau khi đăng nhập.",
