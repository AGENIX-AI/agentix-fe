...
export function TypingIndicator({ avatar_url, name }: TypingIndicatorProps) {
  ...
  return (
    <div className="flex items-start flex-col">
      ...
      <div className="flex max-w-[80%] items-center gap-3 rounded-lg bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 shadow-sm px-4 py-3 text-foreground ml-6" aria-label={t('chat.message.typing')}>
