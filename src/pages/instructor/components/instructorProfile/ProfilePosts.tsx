        ...
        <div className="ml-3">
          <div className="flex items-center">
            ...
            <ExtraSmall className="ml-2 text-muted-foreground">
              {t("instructorProfile.firstDegree")}
            </ExtraSmall>
          </div>
          <ExtraSmall className="text-muted-foreground">
            {t("instructorProfile.entrepreneurshipRole")}
          </ExtraSmall>
          <ExtraSmall className="text-muted-foreground">
            {t("instructorProfile.timeAgo", { time: "3w" })} ·{" "}
...
export function ProfilePosts({
  ...
  return (
    <div className="mt-6">
      <H6>{t("instructorProfile.instructorPosts", { name: instructorName })}</H6>
      ...
      {hasPosts ? (
        ...
        <div className="mt-8 flex flex-col items-center justify-center">
          ...
          <ExtraSmall className="mt-2 text-muted-foreground">
            {t("instructorProfile.noPostsAvailable")}
          </ExtraSmall>
        </div>
      )}
    </div>
